...
func Match(data []byte) (Type, error) {
	...
	if err != nil {
		return Type{}, sderr.Wrap(err, "sdfiletype match error")
	}
	return t, nil
}
...
func MatchReader(r io.Reader) (Type, error) {
	...
	if err != nil {
		return Type{}, sderr.Wrap(err, "sdfiletype match reader error")
	}
	return t, nil
}
...
func MatchFile(filename string) (Type, error) {
	...
	if err != nil {
		return Type{}, sderr.Wrap(err, "sdfiletype match file error")
	}
	return t, nil
}
